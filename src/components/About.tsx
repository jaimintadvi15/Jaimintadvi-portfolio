    ...
    <section className="py-20 px-4 max-w-6xl mx-auto scroll-mt-24 relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-4 flex flex-col gap-6">
          {/* Main Photo Card */}
          <div className="glass-card rounded-3xl p-4 border border-[#22c55e]/30 bg-[#040806]/90 backdrop-blur-2xl relative overflow-hidden group shadow-[0_15px_40px_rgba(0,0,0,0.8)]">
            {/* Ambient Background Radial Glow */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 bg-[#22c55e]/15 rounded-full blur-[60px] -z-10" />

            {/* Profile Photo Container */}
            <div className="w-full h-80 rounded-2xl overflow-hidden border border-[#22c55e]/30 shadow-2xl bg-[#060c09] relative">
              <img
              ...
              {/* Status Badge Tag */}
              <div className="absolute top-3 right-3 bg-[#040806]/90 border border-[#22c55e]/40 backdrop-blur-md px-3 py-1 rounded-full flex items-center gap-2 text-[10px] font-mono text-emerald-300 font-bold shadow-lg">
            ...
            <div className="mt-3.5 px-1 flex items-center justify-between font-mono text-xs text-slate-400">
              <span className="text-[#22c55e] font-bold tracking-wider">JAIMIN_TADVI_PROFILE.SYS</span>
              <span className="text-slate-500">MSU BARODA</span>
            </div>
          </div>

          {/* Sub-Card: Code Vimarsh Web Team Lead Banner */}
          <div className="glass-card rounded-3xl p-5 border border-[#22c55e]/30 bg-[#040806]/90 backdrop-blur-xl relative overflow-hidden flex flex-col justify-between group shadow-xl">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="inline-flex items-center gap-1 text-[10px] font-mono text-emerald-400 bg-emerald-500/10 px-2.5 py-0.5 rounded-full border border-emerald-500/30 font-bold">
                <Sparkles className="w-3 h-3 text-emerald-400" /> WEB LEAD
              </span>
            </div>
        ...
        <div className="lg:col-span-8 flex flex-col space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-2 bg-[#040806] border border-[#22c55e]/30 rounded-2xl p-1.5 w-fit shadow-xl font-mono">
          ...
          {/* Tab Content Box */}
          <div className="glass-card rounded-3xl p-6 sm:p-8 border border-[#22c55e]/30 bg-[#040806]/90 backdrop-blur-2xl relative overflow-hidden min-h-[360px] flex flex-col justify-between shadow-2xl">
            ...
            {activeTab === 'skills' && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
                ...
                <div className="space-y-3">
                  <h3 className="font-mono font-bold text-xs text-emerald-400 tracking-wider flex items-center gap-1.5 uppercase">
                    <span className="text-teal-300 font-extrabold">&gt;</span> PROGRAMMING &amp; WEB
                  </h3>
                  <div className="flex flex-wrap gap-2">
                    {programmingSkills.map((skill) => (
                      <span
                        key={skill}
                        className="text-xs font-mono font-medium text-slate-200 border border-[#22c55e]/30 bg-[#060c09] px-3 py-1.5 rounded-lg hover:border-emerald-400 hover:bg-[#22c55e]/15 hover:text-emerald-300 transition-all duration-300 cursor-default shadow-sm"
                      >
                        {skill}
                      </span>
                    ))}
                ...
                <div className="space-y-3">
                  <h3 className="font-mono font-bold text-xs text-emerald-400 tracking-wider flex items-center gap-1.5 uppercase">
                    <span className="text-teal-300 font-extrabold">&gt;</span> FRAMEWORKS &amp; SYSTEMS
                  </h3>
                  <div className="flex flex-wrap gap-2">
                ...
                <div className="space-y-3">
                  <h3 className="font-mono font-bold text-xs text-emerald-400 tracking-wider flex items-center gap-1.5 uppercase">
                    <span className="text-teal-300 font-extrabold">&gt;</span> DATABASES &amp; TOOLS
                  </h3>
                  <div className="flex flex-wrap gap-2">
                ...
                <div className="space-y-3">
                  <h3 className="font-mono font-bold text-xs text-emerald-400 tracking-wider flex items-center gap-1.5 uppercase">
                    <span className="text-teal-300 font-extrabold">&gt;</span> AI/ML &amp; CORE SKILLS
                  </h3>
                  <div className="flex flex-wrap gap-2">
              ...
              <div className="space-y-6 text-left">
                {experienceData.map((exp) => (
                  <div
                    ...
                    className="relative overflow-hidden rounded-2xl p-5 bg-[#060c09] border border-[#22c55e]/30 hover:border-emerald-400 transition-all duration-300"
                  >
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-3">
                      <div>
                        <span className="font-mono text-xs text-emerald-400 tracking-wider uppercase font-bold block mb-0.5">
                          {exp.company}
                        </span>
                      ...
                      <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#22c55e]/10 border border-[#22c55e]/30 text-xs text-emerald-300 font-mono font-bold">
                    ...
                    <div className="flex flex-wrap gap-1.5 pt-2 border-t border-white/5">
                      {(exp.tags || []).map((tech) => (
                        <span
                          key={tech}
                          className="text-[10px] font-mono px-2.5 py-0.5 rounded bg-[#22c55e]/10 border border-[#22c55e]/30 text-emerald-300 font-semibold"
                        >
                          {tech}
                        </span>
                      ))}
            ...
            {activeTab === 'education' && (
              <div className="space-y-6 text-left">
                <div className="rounded-2xl p-5 bg-[#060c09] border border-[#22c55e]/30">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-3">
                    <div>
                      <span className="font-mono text-xs text-emerald-400 tracking-wider uppercase font-bold block mb-0.5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-3 border-t border-white/5 font-mono text-xs">
                    <div className="p-3 rounded-xl bg-[#040806] border border-[#22c55e]/30">
                      <span className="text-emerald-400 font-bold block">Coding Showdown Rank</span>
                      <span className="text-slate-200">Rank #12 / 150+ in MSU C++ Contest</span>
                    </div>
                    <div className="p-3 rounded-xl bg-[#040806] border border-emerald-500/30">
                      <span className="text-emerald-300 font-bold block">Technical Lead</span>
